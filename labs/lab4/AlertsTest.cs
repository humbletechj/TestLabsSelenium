...
namespace labs.lab4
{
    ...
    public class AlertsTest
    {
        ...
        public void AlertsFormTest()
        {
            ...
            Assert.That(alert1Text, Does.Contain("You clicked a button"), 
                "Alert 1 should contain 'You clicked a button'");
            ...
            var alert2 = wait.Until(ExpectedConditions.AlertIsPresent());
            string alert2Text = alert2.Text;
            Assert.That(alert2Text, Does.Contain("This alert appeared after 5 seconds"), 
                "Alert 2 should contain 'This alert appeared after 5 seconds'");
            ...
            Assert.That(alert3Text, Does.Contain("Do you confirm action?"), 
                "Alert 3 should contain 'Do you confirm action?'");
